...
def main():
    ...
    available_tickers = ["VOICE.IC","VIS.IC","BNORDIK.IC","EIM.IC","EIK.IC","REITIR.IC","HAMP.IC","HAGA.IC","GRND.IC","NYHR.IC","TM.IC","SJOVA.IC","REGINN.IC","N1.IC","MARL.IC","OSSRU.IC","ICEAIR.IC","SIMINN.IC","SFSB.IC"]
