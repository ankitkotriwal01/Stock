...
def main():
    ...
    available_tickers = ["AKSO.OL","STL.OL","WWASA.OL","OTS.OL","ORK.OL","IOX.OL","EKO.OL","DNO.OL","AQUA.OL","AKER.OL","AFK.OL","STB.OL","SSHIP.OL","OPERA.OL","NOD.OL","MEDI.OL","HNB.OL","AWDR.OL","ASETEK.OL","SDRL.OL","BWO.OL","SEVDR.OL","GOGL.OL","FRO.OL","HLNG.OL","DETNOR.OL","DAT.OL","THIN.OL","NOR.OL","BXPL.OL","GYL.OL","FUNCOM.OL","FLNG.OL","FAR.OL","BAKKA.OL","PGS.OL","WWIB.OL","MHG.OL","HYARD.OL","HEX.OL","WWI.OL","JIN.OL","SSC.OL","PLCS.OL","SSI.OL","SIOFF.OL","KVAER.OL","KOG.OL","KIT.OL","KID.OL","WRL.OL","SUBC.OL","MULTI.OL","WEIFA.OL","VEI.OL","SKI.OL","RENO.OL","REC.OL","NAS.OL","ITX.OL","IMSK.OL","GRO.OL","BON.OL","BIRD.OL","AUSS.OL","AFG.OL","YAR.OL","XXL.OL","WBULK.OL","TGS.OL","TEL.OL","STLFUT.OL","SSO.OL","SRBANK.OL","SPU.OL","SOFF.OL","SEVAN.OL","SCI.OL","SCHB.OL","SCHA.OL","SBO.OL","RGT.OL","RISH.OL","REACH.OL","PHO.OL","PGSFUT.OL","NTS.OL","NSG.OL","NRC.OL","NPRO.OL","NHY.OL","NEXT.OL","NEL.OL","SONG.OL","HSPG.OL","GOGL-R.OL","FOE.OL","EIOF.OL","QFR.OL","QEC.OL","GIG.OL","VIZ.OL","OCY.OL","ZAL.OL","ASC.OL","COV.OL","ABT.OL","AEGA.OL","APCL.OL","AGA.OL","AKA.OL","SOAG.OL","AKVA.OL","ALNG.OL","AMSC.OL","APP.OL","ARCHER.OL","NAVA.OL","NANO.OL","LSG.OL","ITE.OL","IDEX.OL","HFISK.OL","HAVI.OL","GSF.OL","GOD.OL","EAM.OL","DOF.OL","DOLP.OL","BOUVET.OL","BIOTEC.OL","BEL.OL","ATEA.OL","BMA.OL","BOR.OL","KOA.OL","DNOFUT.OL","AURLPG.OL","SER.OL","POL.OL","PEN.OL","NOM.OL","NORTH.OL","TIDE.OL","SOLV.OL","EMGS.OL","NATTO.OL","LINK.OL","VISTIN.OL","MSEIS.OL","BIONOR.OL","STBFUT.OL","GJFFUT.OL","SKBN.OL","EPR.OL","PCIB.OL","NRS.OL","PROTCT.OL","WILS.OL","STORM.OL","GJF.OL","REM.OL","BERGEN.OL","CXENSE.OL","IGNIS.OL","RECSOL.OL","REPANT.OL","RECFUT.OL","SALM.OL","HNA.OL","TOM.OL","MCG.OL","HBC.OL","BRG.OL","OLT.OL","SVEG.OL","SAGA.OL","VVL.OL","ENTRA.OL","HUGO.OL","TELFUT.OL","TTS.OL","VARDIA.OL","ATLA-NOK.OL","AVM.OL","AVANCE.OL","AXA.OL","PCIB-T.OL","BWLPG.OL","TEAM.OL","SNI.OL","ROM.OL","ODL.OL","SBVG.OL","RCL.OL","PDR.OL","DESSC.OL","SDSD.OL","PRS.OL","SBX.OL","NAPA.OL","SENDEX.OL","DNBFUT.OL","DNB.OL","PROS.OL","EMAS.OL","RAKP.OL","RING.OL","HELG.OL","NGT.OL","ISSG.OL","JAEREN.OL","MELG.OL","TIL.OL","MORG.OL","AURG.OL","SKUE.OL","NONG.OL","SOR.OL","SPOG.OL","ODFB.OL","STRONG.OL","TOTG.OL","SADG.OL","PHLY.OL","ODF.OL","PPG-PREF.OL","NTSG.OL","MING.OL","SIOFF-T.OL","SAS-NOK.OL"]
